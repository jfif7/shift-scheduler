  ...
  return (
    <article className="container mx-auto max-w-3xl px-6 py-12">
      ...
      <ul className="mt-4 list-disc space-y-2 pl-6 leading-8">
        ...
        <li>勞基法工時制度：可選擇「一例一休」或「四週變形」，系統會強制每位員工的連續上班與休假天數符合該制度。</li>
      </ul>

      <p className="mt-4 leading-8 text-sm text-muted-foreground">
        提醒：勞基法工時制度僅涵蓋以「天數」為基準的規定（連續上班與休假天數）。以「小時」為基準的規定──例如輪班間隔 11 小時（§34）、每日／每週工時與加班上限（§30、§32）──因系統未建立班次時間模型，無法自動檢查，仍須由管理者自行確認。
      </p>
