...
export const metadata: Metadata = {
  title: "隱私權政策",
  description: "班表管理系統的隱私權政策：資料儲存方式、Cookie 與廣告、第三方服務說明。",
}
...
export default function PrivacyPage() {
  return (
    <article className="container mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mt-2 text-sm text-muted-foreground">最後更新：2026 年 6 月</p>
      ...
      <ul className="mt-4 list-disc space-y-2 pl-6 leading-8">
        <li>
          <strong>未登入時</strong>：所有資料僅儲存在你自己的瀏覽器（localStorage），不會上傳到伺服器。
        </li>
        <li>
          <strong>登入時</strong>：本服務透過 Google 帳號進行身分驗證（Firebase
          Authentication），並將你的排班資料儲存於 Google Firestore，以便跨裝置同步。
        </li>
      </ul>

      <h2 className="mt-10 text-2xl font-semibold">Cookie 與廣告</h2>
      <p className="mt-4 leading-8">
        本網站使用 Google AdSense 顯示廣告。Google 及其合作夥伴會使用 Cookie，依據你造訪本網站及其他網站的紀錄來放送廣告。你可以前往{" "}
        <a
        ...
        ，管理或停用個人化廣告。第三方廠商的 Cookie 使用受其各自的隱私權政策規範，你也可以參考{" "}
        <a
      ...
      <p className="mt-4 leading-8">本服務並非針對 13 歲以下兒童設計，亦不會刻意收集兒童的個人資料。</p>

      <h2 className="mt-10 text-2xl font-semibold">政策變更</h2>
      <p className="mt-4 leading-8">我們可能不時更新本政策，更新後會於本頁公告最新版本與日期。</p>
