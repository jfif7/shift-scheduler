...
- **Landing**: User sees the main interface with two tabs: Setup and Constraints
...
- **Navigation**: User scrolls to the schedule generation section in the Setup tab
